  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col justify-between">
                ...
                >
                  ...
                  <div className="flex gap-2 shrink-0 w-full sm:w-auto mt-2 sm:mt-0">
                    <button
                      ...
                      className="flex-1 sm:flex-none px-3 py-3 sm:py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-800 rounded-xl text-sm sm:text-xs font-bold flex items-center justify-center gap-1.5 transition-colors cursor-pointer border border-slate-200 min-h-[44px]"
                    >
                      <QrCode size={16} className="text-emerald-700" />
                      <span className="inline">Camera</span>
                    </button>
                    <button
                      type="submit"
                      className="flex-1 sm:flex-none px-5 py-3 sm:py-2.5 bg-emerald-700 hover:bg-emerald-800 text-white rounded-xl text-sm sm:text-xs font-bold transition-all shadow-sm flex items-center justify-center gap-1.5 cursor-pointer min-h-[44px]"
                    >
      ...
      <section className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        {/* 5 Stage Tab Stepper */}
        <div className="flex overflow-x-auto sm:grid sm:grid-cols-5 gap-3 sm:gap-2 mb-6 pb-2 snap-x snap-mandatory hide-scrollbar">
          {pipelineStages.map((stage, idx) => {
            ...
            return (
              <button
                ...
                className={`min-w-[160px] sm:min-w-0 flex-shrink-0 snap-center p-3.5 rounded-2xl text-left transition-all border cursor-pointer ${
                  isActive
