...
export const MOCK_USERS: User[] = [
  ...
  },
  {
    ...
    certifications: ['India Organic NPOP', 'FSSAI Jaivik Bharat', 'AYUSH Premium Mark', 'FairWild Certified'],
  ...
  },
  {
    ...
    certifications: ['GMP Certified (AYUSH)', 'ISO 22000:2018', 'FSSAI Manufacturing License'],
  ...
  },
  {
    ...
    certifications: ['ISO/IEC 17025 NABL Accredited', 'FSSAI Notified Laboratory', 'AYUSH Approved Drug Testing Lab'],
  ...
  },
  {
    ...
    certifications: ['GDP Compliant (Good Distribution Practice)', 'ISO 9001:2015', 'FSSAI Logistics License'],
  ...
  },
  {
    ...
    certifications: ['FSSAI Retail License', 'AYUSH Premium Retailer Guild', 'Jaivik Bharat Member'],
  ...
  // Pending Approval User for demonstration
  {
    ...
    certifications: ['Rainforest Alliance (Under Audit)', 'India Organic NPOP'],
...
export const INITIAL_PRODUCTS: BotanicalProduct[] = [
  {
    ...
    certificates: [
      ...
      {
        id: 'CERT-002',
        type: 'AYUSH Premium Mark Certified',
        certificateNumber: 'AYUSH-PRM-IND-2024-04',
        issuingAuthority: 'Quality Council of India (QCI) / Ministry of AYUSH',
    ...
    processingDetails: {
      ...
      facilityLocation: 'Peenya Biotech Park ISO Cleanroom #3, Bengaluru',
      ...
      notes: 'Root cleansed with double-filtered deionized water, sterilized via dry-steam autoclave, milled to 80-mesh fine powder under AYUSH GMP.',
      txHash: '0x8f3b9c71a2e4d567890123456789abcdef0123456789abcdef0123456789abcd'
    },
    labReport: {
      labId: 'USR-LAB-01',
      labName: 'Eurofins NABL Analytical Testing Lab',
      ...
      notes: 'Batch passed all Ayurvedic Pharmacopoeia of India (API) & FSSAI 2023 botanical monograph criteria. Zero synthetic pesticide residue detected (<0.001 mg/kg limit).',
    ...
    shipmentDetails: {
      ...
      distributorName: 'TransGlobal Cold-Chain Logistics India Pvt Ltd',
      sourceLocation: 'Bangalore Central Pharma Logistics Hub, Nelamangala, Karnataka',
      destinationLocation: 'Arogya Ayurvedic Retail Depot, Indiranagar, Bengaluru',
      ...
      expectedDeliveryDate: '2024-07-12T18:00:00Z',
      actualDeliveryDate: '2024-07-12T14:30:00Z',
      status: 'DELIVERED',
      trackingNumber: 'TG-IND-2024-991204',
      txHash: '0x123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0'
    },
    retailDetails: {
      retailerId: 'USR-RET-01',
      retailerName: 'Arogya Pure Herbals & Ayurvedic Dispensary',
      storeLocation: '100 Feet Road, Indiranagar, Bengaluru, Karnataka 560038',
      receivedDate: '2024-07-14T10:00:00Z',
      shelfBatchId: 'RET-BLR-ASH-089',
      unitPrice: 850.00,
      qrCodeGenerated: true,
      notes: 'Inventory inspected, physical seals matched blockchain hash, batch placed on verified Ayurvedic wellness shelf.',
    ...
    timeline: [
      {
        ...
        description: 'Harvested 500kg certified organic Withania somnifera. Geo-tagged soil telemetry and India Organic NPOP certificate attached.',
      ...
      },
      {
        ...
        actorName: 'Mahesh Deshmukh',
        actorRole: 'PROCESSOR',
        location: 'PhytoExtracts Bio-Refining Hub, Peenya, Bengaluru',
      ...
      },
      {
        ...
        location: 'Eurofins NABL Analytics Lab, Hyderabad/Bengaluru',
        description: 'Comprehensive HPLC & ICP-MS testing completed. Withanolides confirmed at 5.42%, Heavy metals <0.05ppm, zero pesticides. NABL Certificate issued.',
        txHash: '0x3a4b5c6d7e8f90123456789abcdef0123456789abcdef0123456789abcdef01',
        status: 'COMPLETED',
      ...
      },
      {
        ...
        actorName: 'Vikramjit Singh',
        actorRole: 'DISTRIBUTOR',
        location: 'Nelamangala Hub → Indiranagar Store, Bengaluru',
        description: 'Shipped under strict GDP temperature loggers (18°C-22°C continuous). Delivered and verified at retailer dispensary.',
        txHash: '0x123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0',
        status: 'COMPLETED',
        metadata: { 'Tracking': 'TG-IND-2024-991204', 'Temp Stability': '100% compliant' }
      },
      {
        id: 'TL-5',
        ...
        actorRole: 'RETAILER',
        location: 'Arogya Pure Herbals, Indiranagar, Bengaluru',
    ...
    blockchainTransactions: [
      ...
      },
      {
        ...
        actor: 'Mahesh Deshmukh (Org: ProcessorMSP)',
        actorRole: 'PROCESSOR',
      ...
      },
      {
        ...
        actor: 'Vikramjit Singh (Org: DistributorMSP)',
        actorRole: 'DISTRIBUTOR',
      ...
      },
      {
        ...
        actor: 'Aarav Mehta (Org: RetailerMSP)',
        actorRole: 'RETAILER',
  ...
  },
  {
    ...
    description: 'World renowned Lakadong variety with exceptional natural curcumin content (>8.0%). Sun-cured and vacuum packaged in nitrogen atmosphere under Spices Board of India standards.',
    ...
    certificates: [
      {
        ...
        issuingAuthority: 'APEDA / Spices Board India',
    ...
    processingDetails: {
      ...
      facilityLocation: 'Guwahati Biotech Processing Terminal, Assam',
    ...
    labReport: {
      ...
      overallResult: 'APPROVED',
      notes: 'Curcumin potency at 8.42% w/w, well exceeding the 7.5% API pharmacopoeia standard. Lead test non-detectable.',
    ...
    shipmentDetails: {
      ...
      distributorId: 'USR-DST-01',
      distributorName: 'TransGlobal Cold-Chain Logistics India Pvt Ltd',
      sourceLocation: 'Guwahati Agro-Logistics Depot, Assam',
      destinationLocation: 'TransGlobal Central Logistics Park, Bhiwandi, Maharashtra',
      vehicleNumber: 'AS-01-TC-8831 / MH-04-TG-2011',
      transportType: 'STANDARD_LOGISTICS',
      temperatureRange: '15°C - 25°C',
      dispatchDate: '2024-08-10T12:00:00Z',
      expectedDeliveryDate: '2024-08-16T18:00:00Z',
      status: 'IN_TRANSIT',
      trackingNumber: 'TG-IND-2024-88419',
